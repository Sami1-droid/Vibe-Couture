      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              ...
              From timeless classics to modern masterpieces, we help you find the perfect fragrance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/products?category=eau-de-parfum" className="text-gray-400 hover:text-white transition-colors">Eau de Parfum</Link></li>
              <li><Link to="/products?category=eau-de-toilette" className="text-gray-400 hover:text-white transition-colors">Eau de Toilette</Link></li>
              <li><Link to="/products?gender=men" className="text-gray-400 hover:text-white transition-colors">Men's Fragrances</Link></li>
              <li><Link to="/products?gender=women" className="text-gray-400 hover:text-white transition-colors">Women's Fragrances</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-gray-400 mb-4">Get the latest updates on new arrivals and exclusive offers.</p>
            <div className="flex gap-2">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:ring-2 focus:ring-primary-600 focus:border-transparent text-white placeholder-gray-400"
              />
